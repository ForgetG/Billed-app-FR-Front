      ...
      <div class='dashboard-content'>
        ...
        <div class='bills-feed'>
          ...
          <div class='status-bills-header'>
            <h3> En attente (<span id="arrow-icon-bills-pending-len">${filteredBills(data && data.bills, "pending").length}</span>) </h3>
          ...
          <div class='status-bills-header' style='margin-top: 20px;'>
            <h3> Validé (<span id="arrow-icon-bills-accepted-len">${filteredBills(data && data.bills, "accepted").length}</span>) </h3>
          ...
          <div class='status-bills-header' style='margin-top: 20px;'>
            <h3> Refusé (<span id="arrow-icon-bills-refused-len">${filteredBills(data && data.bills, "refused").length}</span>) </h3>
        ...
        <div class='deds-feed' style='margin-top: 40px;'>
          ...
          <div class='status-deds-header'>
            <h3> En attente (<span id="arrow-icon-deds-pending-len">${filteredDeds(data && data.deds, "pending").length}</span>) </h3>
          ...
          <div class='status-deds-header' style='margin-top: 20px;'>
            <h3> Validé (<span id="arrow-icon-deds-accepted-len">${filteredDeds(data && data.deds, "accepted").length}</span>) </h3>
          ...
          <div class='status-deds-header' style='margin-top: 20px;'>
            <h3> Refusé (<span id="arrow-icon-deds-refused-len">${filteredDeds(data && data.deds, "refused").length}</span>) </h3>
